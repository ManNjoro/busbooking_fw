...
session_start();
  ...
  if($_SERVER['REQUEST_METHOD'] == "POST")
  {
   ...
   // echo $user_name;
    ...
    if(!empty($phone) && !empty($password) && !empty($con_pass) && !is_numeric($email))
    {
       ...
       if($password==$con_pass){
        ...
        //   $password=md5($password);//
            ...
            $query = "insert into users (email,first_name,last_name,phone, password) values ('$email','$fname','$lname','$phone','$password')";
