    ...
    <form action="#" method="POST">
      <div class="form_wrap">
        ...
        <div class="input_wrap">
          ...
          <input type="datetime-local" id="title" name="departure_datetime" placeholder="Datetime of Departure" class="idclass" required>
        </div>
        ...
        <div class="input_wrap">
          ...
          <input type="number" min="1" id="title" name="cost" placeholder="Cost" class="idclass" required>
        </div>
